...
// import { logoutSagaAction } from "../../Store/SagaActions/AuthSagaActions";
...
export default function Header() {
  ...
  const routeChange = () => {
    ...
    navigate(path);
    // disptach(logoutSagaAction(({ model, callback: getSignoutdata })))

  }
  const getSignoutdata = (data) => {
    if (data) {
      let path = `/`;
      sessionStorage.clear()
      navigate(path);
        ...
        <div className="main-header-left ">
          <div className="responsive-logo">
            <Link to={`/dashboard/`} className="header-logo">
              ...
              />
              <img
                src="/Images/synizenLogoDark.svg"
                height={45}
          ...
          <div className="logo-horizontal">
            <Link to={`/dashboard/dashboard-1`} className="header-logo">
              <img
          ...
          <div className="mb-0 navbar navbar-expand-lg   navbar-nav-right responsive-navbar navbar-dark p-0">
            <Navbar.Collapse className="collapse" id="navbarSupportedContent-4">
              <ul className="nav nav-item header-icons navbar-nav-right ">
                ...
                <li
                  className="nav-item full-screen fullscreen-button d-flex"
                ...
                <li><div className="text-wrap text-center">
                  <div className="example" style={{ border: "none", marginTop: "8px", marginRight: "-22px" }}>
                    <h6 className="text-primary">Hey {headerName}{" "}!</h6>
                  </div>
                </div></li>
                ...
                <Dropdown className=" main-profile-menu nav nav-item nav-link ps-lg-2 d-flex">
                  <Dropdown.Toggle
                    className="new nav-link profile-user "
                    variant=""
                  >
