              ...
              <ul className="nav nav-item header-icons navbar-nav-right ms-auto">
                  ...
                  <Dropdown.Menu>
                    <div className="menu-header-content text-start border-bottom">
                      <div className="d-flex">
                        ...
                        <span className="badge badge-pill bg-indigo ms-auto my-auto float-end">
                          {
                            getdata.length ? <>Items ({getdata.length})</> : <>Items (05)</>
                          }
                        </span>
                      </div>
                    </div>
                                ...
                                getdata.map((e) => {
                                  return (
                                    <Fragment key={e.id}>
                                      ...
                                      <div onClick={handleClose} className="dropdown-item d-flex border-bottom main-cart-item">
                                        <Link to={`/pages/e-commerce/productDetails`}>
                                          <img src={(e.src)} className="drop-img cover-image" alt="" />
                                        </Link>
                                        <div className="ms-3 text-start">
                                          <p className="mb-1 text-muted tx-13">{e.name}</p>
                                          <span className="text-dark tx-semibold tx-12">$ : {e.price}</span>
                                        </div>
                                        <div className="ms-auto my-auto">
                                          <div className="" onClick={() => ondelete(e.id)}>
                    ...
                    <div className="dropdown-footer text-start">
                      ...
                      <span className="float-end mt-1 tx-semibold">
                        {getdata.length ? <>Sub Total: $ {price}</> : <> Sub Total : $ 485.93</>}
                      </span>
                    </div>
                  </Dropdown.Menu>
                </Dropdown>
                ...
                <Dropdown className=" main-profile-menu nav nav-item nav-link ps-lg-2">
                  ...
                  >
                    <img
                      alt=""
                      src={require("../../assets/img/syntizen/jagan-sir.jpg")}
                      className=""
                    />
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
